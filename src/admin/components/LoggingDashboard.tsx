        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                className={`px-3 py-1 rounded-md ${isLive ? "bg-green-500 text-white" : "bg-gray-200"
                  }`}
                    ...
                    Object.entries(analyticsData.logsByLevel).map(
                      ([level, count]) => (
                        <button
                          ...
                          className={`flex items-center space-x-1 px-3 py-2 rounded-md text-sm ${selectedLevel === level
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {currentLogs.map((log, index) => (
                      <tr
                        key={index}
                        className={`border-t hover:bg-gray-50 cursor-pointer ${log.level === "ERROR" ? "bg-red-50" : ""
                          }`}
                      ...
                      >
                        ...
                        <td className="p-3">
                          <button
                            ...
                            className={`px-2 py-1 rounded-md text-xs ${selectedCorrelationId === log.correlationId
                                ? "bg-blue-500 text-white"
                                : "bg-gray-200"
                              }`}
                          >
